...
function encode_window_update(frame)
    payload = [ UInt8(header.window_size_increment >> 24) & 0x7f;
                UInt8(header.window_size_increment >> 16 & 0x000000ff);
                UInt8(header.window_size_increment >> 8 & 0x000000ff);
                UInt8(header.window_size_increment & 0x000000ff) ]
